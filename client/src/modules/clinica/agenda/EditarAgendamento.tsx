...
export default function EditarAgendamento({ agendamento, onClose, onSave }: EditarAgendamentoProps) {
  ...
  useEffect(() => {
    if (agendamento) {
      setFormData({
        ...
        patientPhone: agendamento.patientPhone || '',
        patientEmail: agendamento.patientEmail || '',
        procedure: agendamento.procedure || '',
        date: agendamento.date || '',
        time: agendamento.time || '',
        duration: agendamento.duration || '60',
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.status} onValueChange={(value) => setFormData({...formData, status: value})}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="faltou">Paciente Faltou</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
